...
# def promediador_señales_tiempo(freq=20, duracion=10, name='xxxkHz_yyydA_100Mss_ciclo', subdir=True, plot_range=0.04):
#     '''
#     Durante medida iterativa, promedia durante un período de tiempo especificado.
#     Luego guarda un archivo ASCII con:
#         |t| |CH1| |CH2|
#     Parameters
#     ----------
#     duracion : int
#                Duración de la adquisición en segundos.
...
#         if time() >= t_end:
#             y1 = y1 / (indx - indx_corte + 1)
#             y2 = y2 / (indx - indx_corte + 1)
...
#             print('-'*50,'\nAdquisición finalizada')
#             print(f'Se ha salvado un archivo')
#             break
        
#         if (indx > 0 and indx % 19 == 0):
#             y1 = y1 / 20
#             y2 = y2 / 20
...
#         sleep(0.05)  # Pequeña pausa para evitar consumo excesivo de CPU
...
promediador_señales(freq=20,num_prom=20, 
                    name='265kHz_100dA_100Mss_Ni0sRC',
                    plot_range=0.05)
